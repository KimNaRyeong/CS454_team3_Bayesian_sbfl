...
def adjust_tarantula_values(bn, spectrum_data):
    ...
    for node in bn.nodes:
        ...
        if node in spectrum_data:
            adjusted_data[node]["tarantula"] = node_data["tarantula"]
...
# Paths
bayesian_networks_folder = '/root/workspace/CS454_team3_Bayesian_sbfl/bayesian_networks'
spectrum_file = '/root/workspace/CS454_team3_Bayesian_sbfl/method_level_spectrums_with_tarantula.json'
output_file = '/root/workspace/CS454_team3_Bayesian_sbfl/adjusted_spectrum.json'
